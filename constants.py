...
DB_NAMES = {
    ...
    DB_RECRUIT_PATH: f"{RAG_TOP_FOLDER_PATH}/recruit",
}
...
SEARCH_RECRUIT_INFO_TOOL_NAME = "search_recruit_info_tool"
SEARCH_RECRUIT_INFO_TOOL_DESCRIPTION = "採用に関する情報を参照したい時に使う"
